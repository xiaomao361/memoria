...
- `~/.qclaw/skills/memoria/links.json` — 链接索引
...
| 「记一下」+ 项目/技术/决策 | 方案、待办、约定 | `archive_important.py --auto` | 冷存储 + 向量化 |
| 「单独记」「全量记」「这个很重要」 | 任何 | `archive_important.py --content` | 冷存储 + 向量化 |
